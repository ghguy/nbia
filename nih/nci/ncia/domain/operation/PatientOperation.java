...
public class PatientOperation extends DomainOperation {
	...
	public Object validate(Map numbers) throws Exception {
	    ...
	    try {		    
		    List rs = (List)ida.search(buildQueryToFindExistingPatient(numbers, tdp));
