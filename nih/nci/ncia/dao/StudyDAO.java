...
public class StudyDAO extends AbstractDAO {
     ...
     */
    public List<StudyDTO> findStudiesBySeriesId(Collection<Integer> seriesPkIds) throws Exception {
        ...
        try{
	        ...
	        List<Object[]> seriesResults = dataAccess.search(selectStmt + fromStmt + whereStmt);
        	...
        	e.printStackTrace();
        	logger.error("Exception in DICOMPatientQueryHandler: " + e);
	...
	/////////////////////////////////////PRIVATE/////////////////////////////////////////
    private static String SQL_QUERY_SELECT = "SELECT distinct series.id, study.id, study.studyInstanceUID, series.seriesInstanceUID, study.studyDate, study.studyDesc, series.imageCount, series.seriesDesc, series.modality, ge.manufacturer, series.seriesNumber, series.annotationsFlag, series.totalSize, series.patientId, study.patient.dataProvenance.project ";
    private static String SQL_QUERY_FROM = "FROM Study study join study.generalSeriesCollection series join series.generalEquipment ge ";
    private static String SQL_QUERY_WHERE = "WHERE series.visibility = '1' ";
