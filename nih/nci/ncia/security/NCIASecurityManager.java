/**
* $Id: NCIASecurityManager.java 11939 2010-01-22 19:48:50Z kascice $
*
...
public class NCIASecurityManager {
    ...
    private static NCIASecurityManager manager = null;
     ...
     * Constructor
     */
    private NCIASecurityManager(String name) throws Exception {
    ...
    public static NCIASecurityManager getInstance() throws Exception {      
        if (manager == null) {
            manager = new NCIASecurityManager(NCIAConfig.getCsmApplicationName());
        }
		...
		try {
			...
			if (dataAccess != null) {
				try {
					...
					logger.error("Error closing database connection in SecurityBean "
									+ e);
				}
			}
