/**
* $Id: AuthorizationManager.java 11885 2010-01-22 19:15:38Z kascice $
*/
...
public class AuthorizationManager {
    ...
    public AuthorizationManager(String userName) throws Exception {
        String userId = NCIASecurityManager.getInstance().getUserId(userName);
        securityRights = NCIASecurityManager.getInstance().getSecurityMap(userId);
    }
    ...
    public AuthorizationManager(Long userId) throws Exception {
        securityRights = NCIASecurityManager.getInstance()
                                            .getSecurityMap(String.valueOf(
                    userId));
    }
    ...
    public List<SiteData> getAuthorizedSites(RoleType role) {
        ...
        for (String comboString : findValuesFromAuthorizationData(
                ...
                PROT_ELEM_PROJECT + NCIAConstants.SITE_DELIMITER + PROT_ELEM_SITE,
                role)) {
