...
public class SearchResultBean {
	...
	public void viewPatient(PatientResultWrapper wrapper) throws Exception {
		...
		System.out.println("got patient with ID " + patient.getSubjectId() + " "
				+ patient.computeFilteredNumberOfSeries());
	...
	public String saveQuery() {
		...
		String queryNameText = "MAINbody:dataForm:queryName";
		...
		if (swb.isEditingSavedQuery()) {
			queryNameText = "MAINbody:dataForm:newQueryName";

			if (updateQuery) {
				QueryStorageManager qManager = new QueryStorageManager();
				long newQueryId;
	...
	private void addNodeResult(PatientSearchResults patientSearchResults) {
		System.out.println("patientSearchResults:"+patientSearchResults.getNode().getDisplayName());
		...
		System.out.println("foundWrapper:"+foundWrapper);
	...
	private void waitForSearchResults(PatientSearchCompletionService completionService) {
		try {    		
			System.out.println("YO!!!!!:"+completionService.getNodesToSearch().size());
