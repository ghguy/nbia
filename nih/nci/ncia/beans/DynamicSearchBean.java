...
import gov.nih.nci.ncia.dynamicsearch.DataFieldTypeMap;
import gov.nih.nci.ncia.dynamicsearch.DynamicSearchCriteria;
import gov.nih.nci.ncia.dynamicsearch.Operator;
import gov.nih.nci.ncia.dynamicsearch.QueryHandler;
import gov.nih.nci.ncia.dynamicsearch.QueryHandlerImpl;
import gov.nih.nci.ncia.dynamicsearch.TableRelationships;
...
public class DynamicSearchBean {
	...
	private void loadPermissibleData(String field) throws Exception
	{
		...
		QueryHandler qh = new QueryHandlerImpl();
		String actualSource = "";
