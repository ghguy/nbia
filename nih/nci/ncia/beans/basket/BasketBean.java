...
public class BasketBean implements Serializable, IcefacesRowColumnDataModelInterface {
    ...
    public String getImageSeriesJavascript() {
        return SlideShowUtil.getImageSeriesJavascript((List<ImageSearchResult>)imageList.getWrappedData());
    }
    ...
    private static String HTTP_DOWNLOAD = NCIAConstants.HTTP_DOWNLOAD;
    private static String FTP_DOWNLOAD = NCIAConstants.FTP_DOWNLOAD;
