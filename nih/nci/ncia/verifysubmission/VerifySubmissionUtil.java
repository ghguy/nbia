...
public class VerifySubmissionUtil {
	...
	public static String getProject(String projectSite) {
    	return projectSite.substring(0, projectSite.indexOf(NCIAConstants.SITE_DELIMITER));
    }
	...
	public static String getSite(String projectSite) {
    	int dex = projectSite.indexOf(NCIAConstants.SITE_DELIMITER);
    	return projectSite.substring(dex+NCIAConstants.SITE_DELIMITER.length());
    }    
	...
	public static String siteDataToString(SiteData siteData) {
    	return siteData.getCollection() + NCIAConstants.SITE_DELIMITER + siteData.getSiteName();    	
    }
	
	public static String siteDataToString(String project, String site) {
    	return project + NCIAConstants.SITE_DELIMITER + site;    	
    }	
