/**
 * UMLAssociationTargetUMLAssociationEdge.java
 *
...
public class UMLAssociationTargetUMLAssociationEdge  implements java.io.Serializable {
    private gov.nih.nci.cagrid.metadata.dataservice.UMLAssociationEdge UMLAssociationEdge;

    public UMLAssociationTargetUMLAssociationEdge() {
    }
    ...
    /**
     * Gets the UMLAssociationEdge value for this UMLAssociationTargetUMLAssociationEdge.
     * 
    ...
    /**
     * Sets the UMLAssociationEdge value for this UMLAssociationTargetUMLAssociationEdge.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UMLAssociationTargetUMLAssociationEdge)) return false;
        UMLAssociationTargetUMLAssociationEdge other = (UMLAssociationTargetUMLAssociationEdge) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UMLAssociationTargetUMLAssociationEdge.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("gme://caGrid.caBIG/1.0/gov.nih.nci.cagrid.metadata.dataservice", ">UMLAssociation>targetUMLAssociationEdge"));
