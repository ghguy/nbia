...
public abstract class NCIACoreServiceResourceBase extends ReflectionResource implements Resource
	...
	static final Log logger = LogFactory.getLog(NCIACoreServiceResourceBase.class);

	private NCIACoreServiceResourceConfiguration configuration;
    ...
    public NCIACoreServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.dataservice.DomainModel getDomainModel(){
		return ((NCIACoreServiceResourceProperties) getResourceBean()).getDomainModel();
	}
	
	public void setDomainModel(gov.nih.nci.cagrid.metadata.dataservice.DomainModel domainModel ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(NCIACoreServiceConstants.DOMAINMODEL);
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((NCIACoreServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	...
	public NCIACoreServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (NCIACoreServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadDomainModelFromFile() {
      if(getDomainModel()==null){
		try {
			...
			((NCIACoreServiceResourceProperties) this.getResourceBean()).setDomainModel((gov.nih.nci.cagrid.metadata.dataservice.DomainModel) Utils.deserializeDocument(dataFile.getAbsolutePath(),
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((NCIACoreServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
