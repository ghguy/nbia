...
/**
 * an attribute (name and value) of an Object instance
 */
public class TargetAttribute  implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TargetAttribute)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TargetAttribute.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://CQL.caBIG/1/gov.nih.nci.cagrid.CQLResultSet", "TargetAttribute"));
