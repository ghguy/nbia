...
public class ServiceImplHelper {
	...
	public static Map<String, String> retrieveImageFiles(CQLQuery cQLQuery)
		...
		try{
		sbSOPInstanceUIDList = CQLQueryProcessorUtil.computeSopInstanceUidOrClauseFromQuery(cQLQuery);
		...
		retrievedFileNames = imageDao.getImagesFiles(sbSOPInstanceUIDList);
		}catch(Exception e){
