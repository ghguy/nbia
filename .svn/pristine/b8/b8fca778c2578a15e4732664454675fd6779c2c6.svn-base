/**
 * RetrieveDicomDataByStudyUIDResponse.java
 *
...
public class RetrieveDicomDataByStudyUIDResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the transferServiceContextReference value for this RetrieveDicomDataByStudyUIDResponse.
     * 
    ...
    /**
     * Sets the transferServiceContextReference value for this RetrieveDicomDataByStudyUIDResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveDicomDataByStudyUIDResponse)) return false;
        RetrieveDicomDataByStudyUIDResponse other = (RetrieveDicomDataByStudyUIDResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveDicomDataByStudyUIDResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ncia.cagrid.nci.nih.gov/NCIACoreService", ">RetrieveDicomDataByStudyUIDResponse"));
