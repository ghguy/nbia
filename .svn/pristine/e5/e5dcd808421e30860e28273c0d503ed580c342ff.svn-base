/**
* $Id: AcquisitionMatrixCriteria.java 4417 2008-04-18 20:43:12Z saksass $
*
 ...
 */
public class AcquisitionMatrixCriteria extends MultipleValuePersistentCriteria
    ...
    public AcquisitionMatrixCriteria(String acquisitionMatrixFrom,
        String acquisitionMatrixFromValue,
        String acquisitionMatrixTo,
        String acquisitionMatrixToValue) {
        rangeData.setFromOperator(acquisitionMatrixFrom);
        rangeData.setFromValue(acquisitionMatrixFromValue);

        if ((acquisitionMatrixTo != null) &&
                !acquisitionMatrixTo.equals("")) {
            rangeData.setToOperator(acquisitionMatrixTo);
            rangeData.setToValue(Double.parseDouble(
            		acquisitionMatrixToValue));
        }
    }

    public AcquisitionMatrixCriteria() {
    }
