/**
 * NCIACoreServiceReference.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package gov.nih.nci.cagrid.ncia.stubs.types;

public class NCIACoreServiceReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public NCIACoreServiceReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this NCIACoreServiceReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this NCIACoreServiceReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof NCIACoreServiceReference)) return false;
        NCIACoreServiceReference other = (NCIACoreServiceReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NCIACoreServiceReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ncia.cagrid.nci.nih.gov/NCIACoreService/types", ">NCIACoreServiceReference"));
