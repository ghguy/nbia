/**
 * ViewDicomHeaderRequestImageSearchResult.java
 *
...
public class ViewDicomHeaderRequestImageSearchResult  implements java.io.Serializable {
    private gov.nih.nci.ncia.search.ImageSearchResult imageSearchResult;

    public ViewDicomHeaderRequestImageSearchResult() {
    }
    ...
    /**
     * Gets the imageSearchResult value for this ViewDicomHeaderRequestImageSearchResult.
     * 
    ...
    /**
     * Sets the imageSearchResult value for this ViewDicomHeaderRequestImageSearchResult.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ViewDicomHeaderRequestImageSearchResult)) return false;
        ViewDicomHeaderRequestImageSearchResult other = (ViewDicomHeaderRequestImageSearchResult) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ViewDicomHeaderRequestImageSearchResult.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ncia.cagrid.nci.nih.gov/NCIACoreService", ">>ViewDicomHeaderRequest>imageSearchResult"));
