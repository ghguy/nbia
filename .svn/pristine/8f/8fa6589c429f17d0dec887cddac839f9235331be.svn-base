/**
* $Id: DataCollectionDiameterCriteria.java 4417 2008-04-18 20:43:12Z saksass $
*
 ...
 *
 */
public class DataCollectionDiameterCriteria extends MultipleValuePersistentCriteria
    implements Serializable, RangeCriteria {
    protected RangeData rangeData = new RangeData();

    public DataCollectionDiameterCriteria(String dataCollectionDiameterFrom,
    ...
    public DataCollectionDiameterCriteria() {
    }
