/**
 * RetrieveDicomDataByPatientIdResponse.java
 *
...
public class RetrieveDicomDataByPatientIdResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the transferServiceContextReference value for this RetrieveDicomDataByPatientIdResponse.
     * 
    ...
    /**
     * Sets the transferServiceContextReference value for this RetrieveDicomDataByPatientIdResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveDicomDataByPatientIdResponse)) return false;
        RetrieveDicomDataByPatientIdResponse other = (RetrieveDicomDataByPatientIdResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveDicomDataByPatientIdResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ncia.cagrid.nci.nih.gov/NCIACoreService", ">RetrieveDicomDataByPatientIdResponse"));
