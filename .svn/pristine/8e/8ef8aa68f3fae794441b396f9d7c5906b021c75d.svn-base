/**
 * NCIACoreServiceAddressingLocator.java
 *
...
public class NCIACoreServiceAddressingLocator extends gov.nih.nci.cagrid.ncia.stubs.service.NCIACoreServiceLocator implements gov.nih.nci.cagrid.ncia.stubs.service.NCIACoreServiceAddressing {
    public gov.nih.nci.cagrid.ncia.stubs.NCIACoreServicePortType getNCIACoreServicePortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	gov.nih.nci.cagrid.ncia.stubs.NCIACoreServicePortType _stub = getNCIACoreServicePortTypePort(endpoint);
	if (_stub != null) {
