...
public class QueryStorageManager {
    ...
    // These represent relative positions of attributes and are used as subattribute names
    //private static final String FIRST_SUB_ATTR = QueryStorageConstants.FIRST_SUB_ATTR;
    //private static final String SECOND_SUB_ATTR =  QueryStorageConstants.SECOND_SUB_ATTR;
    //private static final String THIRD_SUB_ATTR =  QueryStorageConstants.THIRD_SUB_ATTR;
    //private static final String FOURTH_SUB_ATTR =  QueryStorageConstants.FOURTH_SUB_ATTR;

	private static final String DB_CONNECTION_ERROR ="Unable to close database connection ";


    // Logger for this class
    private static Logger logger = Logger.getLogger(QueryStorageManager.class);

    // Data access class used to communicate with Hibernate
    Hibernate3DataAccess dataAccess;

    /**
     * Constructor.   Initializes the data access class
     *
     */
    public QueryStorageManager() {
        try {
     ...
     * @throws Exception
     */
    public long addQueryToHistory(DICOMQuery query) throws Exception {
        ...
        try {
            ...
            if (query.getSavedQueryId() > 0) {
                SavedQuery assocSavedQuery = (SavedQuery) dataAccess.load(SavedQuery.class,
            ...
            logger.error("error storing query history ", e);
            throw new Exception("Problem Storing Query History");
        } finally {
        	CloseDbConnection(dataAccess);
        }
    ...
    private void CloseDbConnection(Hibernate3DataAccess dataAccess){
    	if(dataAccess != null){
    		try{
    			dataAccess.close();
    		}catch(Exception e){
     ...
     * @throws Exception
     */
    private long saveQuery(DICOMQuery query, long savedQueryToInactivateId)
        throws Exception {
        long savedQueryId;
        ...
        try {
            ...
            if (savedQueryToInactivateId > 0) {
                ...
                SavedQuery savedQueryToInactivate = (SavedQuery) dataAccess.load(SavedQuery.class,
                        savedQueryToInactivateId);
                savedQueryToInactivate.setActive(false);
                dataAccess.store(savedQueryToInactivate);
            ...
            Criteria crit = dataAccess.createCriteria(SavedQuery.class);
            ...
            QueryHistory mostRecentQueryHistory = (QueryHistory) dataAccess.load(QueryHistory.class,
            ...
            dataAccess.store(savedQuery);
            dataAccess.update(mostRecentQueryHistory);
            
            savedQueryId = savedQuery.getId();

            logger.info("Saved query record with ID = " + savedQueryId);
        } catch (DuplicateQueryException dqe) {
            throw dqe;
        } catch (Exception e) {
            logger.error("error storing query", e);
            throw new Exception("Problem Storing Query");
        } finally {
        	CloseDbConnection(dataAccess);
        }
     ...
     * @throws Exception
     */
    public long saveQuery(DICOMQuery query) throws Exception {
     ...
     * @throws Exception
     */
    public long updateQuery(DICOMQuery query) throws Exception {
     ...
     * @throws Exception
     */
    public int getSavedQueryCount(String userName) throws Exception {
        Integer count;
        ...
        try {
            ...
            logger.error("error getting saved query count in method getSavedQueryCount", e);
            e.printStackTrace();
            throw new Exception("error getting saved query count in method getSavedQueryCount");
        } finally {
        	CloseDbConnection(dataAccess);
        }
     ...
     * @throws Exception
     */
    public void updateNewResultsFlag(Long savedQueryId)
        throws Exception {
     ...
     * @throws Exception
     */
    public void addNewResultsForQuery(Long savedQueryId)
        throws Exception {
     ...
     * @throws Exception
     */
    private void setNewResultsFlagForQuery(Long savedQueryId, boolean flagValue)
        throws Exception {
        try {
            dataAccess.open();
            dataAccess.beginTransaction();
            
            SavedQuery savedQuery = (SavedQuery) dataAccess.load(SavedQuery.class,
                    savedQueryId);
            ...
            logger.error("error getting saved query count in method setNewResultsFlagForQuery", e);
            throw new Exception("error getting saved query count in method setNewResultsFlagForQuery");
        } finally {
        	CloseDbConnection(dataAccess);
        }
    }
     ...
     * @throws Exception
     */
    public void deleteQueries(List<SavedQueryDTO> savedQueries)
        throws Exception {
        try {
            dataAccess.open();
            dataAccess.beginTransaction();
            ...
            logger.error("Error deleting query", e);
            throw e;
        } finally {
        	CloseDbConnection(dataAccess);
        }
     ...
     * @throws Exception
     */
    public List<QueryHistoryDTO> retrieveQueryHistory(String username)
        throws Exception {
        ...
        try {
            ...
            Criteria crit = dataAccess.createCriteria(QueryHistory.class);
            ...
            while (iter.hasNext() && (count < numberOfQueriesToReturn)) {
                ...
                dto.setCriteriaList(getCriteriaFromStoredAttributes(
                         queryHistory.getQueryHistoryAttributes()));
            ...
            logger.error("error retreiving query", e);
            throw new Exception("Problem Retreiving Query");
        } finally {
        	CloseDbConnection(dataAccess);
        }
     ...
     * @throws Exception
     */
    public List<SavedQueryDTO> retrieveSavedQueries(String username)
        throws Exception {
        try {
            dataAccess.open();
            ...
            return this.populateSavedQueryDTOs(crit.list());
        } catch (Exception e) {
            logger.error("error retreiving query", e);
            throw new Exception("Problem Retreiving Query");
        } finally {
     ...
     * @throws Exception
     */
    public List<SavedQueryDTO> getListOfActiveNoNew() throws Exception {
        try {
            dataAccess.open();
            ...
            return populateSavedQueryDTOs(crit.list());
        } catch (Exception e) {
            logger.error("error retreiving query", e);
            throw new Exception("Problem Retreiving Query");
        } finally {
    ...
    private List<SavedQueryDTO> populateSavedQueryDTOs(List results)
        ...
        while (iter.hasNext()) {
            ...
            dto.setCriteriaList(getCriteriaFromStoredAttributes(
                     savedQuery.getSavedQueryAttributes()));
     ...
     */
    public NCIAUser getUser(String loginName, Hibernate3DataAccess dataAccess) {
        // Create the example criteria and run the query
        NCIAUser user = new NCIAUser();
        user.setLoginName(loginName);

        Criteria crit = dataAccess.createCriteria(NCIAUser.class);
    ...
    private NCIAUser getUser(String loginName) {
        return getUser(loginName, dataAccess);
    }
     ...
     * @throws Exception
     */
    private Set<gov.nih.nci.ncia.criteria.Criteria> getCriteriaFromStoredAttributes(
