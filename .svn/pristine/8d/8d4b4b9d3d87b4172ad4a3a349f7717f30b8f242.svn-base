/**
 * RetrieveDicomDataByNthStudyTimePointForPatientResponse.java
 *
...
public class RetrieveDicomDataByNthStudyTimePointForPatientResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the transferServiceContextReference value for this RetrieveDicomDataByNthStudyTimePointForPatientResponse.
     * 
    ...
    /**
     * Sets the transferServiceContextReference value for this RetrieveDicomDataByNthStudyTimePointForPatientResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveDicomDataByNthStudyTimePointForPatientResponse)) return false;
        RetrieveDicomDataByNthStudyTimePointForPatientResponse other = (RetrieveDicomDataByNthStudyTimePointForPatientResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveDicomDataByNthStudyTimePointForPatientResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ncia.cagrid.nci.nih.gov/NCIACoreService", ">RetrieveDicomDataByNthStudyTimePointForPatientResponse"));
